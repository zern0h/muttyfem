<?php 
    ...
    $title = 'Hamper POS | Muttyfem Supermarket ';
...
<body class="overlay-scrollbar">
    ...
    <!-- Content -->
        <div class="wrapper" style="margin-left: 30px; margin-top: 30px;">
            <h3 class="title" style="margin-bottom: 30px">Hamper Sales</h3>
           <div class="row">
                <div class="col-md-4">
                    <label class="form-label">CASH RECIEVED </label>
                    <input type="text" name="cash_received" id="cash_received" class="
                    form-control">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="customer_change" id="customer_change" class="
                    form-control disable">
                </div>
               
                <div class="col-md-6">
                    <label class="form-label">Search by Hamper Name</label>
                </div>
                <div class="col-md-6">
        ...
        $(document).on('change', '#product_name_search',function(){
           ...
           $.ajax({
                ...
                success:function(data){
                    $('#itemId').val(data.hamper_overview_id);
                    $('#unitPrice').val(data.hamper_total_cost);
...
//$('#barcode').keyup(function (e){
        ...
        $('#action').click(function(event){
			...
			$.ajax({
				...
				success:function(data){
                        ...
                        $('#print_receipt').attr("href",'printHamperReceipt.php?invoiceNUmber='+data.value);
        ...
        $('#cash_received').on('keyup', function(){
            let customer_change = Number($(this).val()) - Number($('#total_cost').val());
