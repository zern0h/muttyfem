...
if($count > 0)
{
    ...
    foreach ($result as $row => $inventory) {
       ...
       $pdf->Cell(10, 5, $id++, 1, 0);
        $pdf->Cell(25, 5, $inventory["barcode"], 1, 0);
        $pdf->Cell(80, 5, $inventory["product_name"], 1, 0);
        $pdf->Cell(10, 5, $inventory["ToalQty"], 1, 0,'C'); 
        $pdf->Cell(24, 5, number_format($inventory["inventory_price"],2), 1, 0,'R'); 
    ...
    $pdf->Cell(24, 5, number_format(0,2), 1, 0,'R'); 
...
$pdf->Cell(189, 5, '[Sales Reports generated by ] '.$_POST['generatedBy'], 0, 1);
