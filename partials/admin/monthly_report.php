...
<body class="overlay-scrollbar">
                ...
                <div class="tabbed" >
                    ...
                    <div class="tabs">
                        ...
                        <div>
                            ...
                            <a href="" target="_blank" class="btn btn-success btn-xs genMonthlySales" id="genMonthlySales" >Generate Monthly Sales Report</a>
    ...
    <script>
        ...
        $(document).on('click', '.genMonthlySales', function(){
            let url ="monthlySalesReport.php?";
            url += 'year=' + $('#monthYear').val() + '&month=' + $('#month').val();
            $(this).attr("href", url);
        });
